...
class Kernel extends BaseKernel
{
    ...
    private function configureContainer(
        ...
        // App configuration.
        $container->import("{$appDir}/framework/**/Resources/config/config.php", null, true);
    ...
    private function configureRoutes(RoutingConfigurator $routes): void
    {
        ...
        $routes->import("{$appDir}/framework/**/Resources/config/routes.php", null, true);
        $routes->import("{$appDir}/src/**/Resources/config/routes.php", null, true);
  }
